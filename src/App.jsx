...
export default function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      text: 'Soluciones que protegen tu salud y patrimonio ante gastos de cuidado a largo plazo.',
    },
    {
      icon: Stethoscope,
      title: 'Seguro Médico',
          ...
          <div className="container hero-grid">
            ...
            >
              <div className="green-card">
                ...
                <p>Consultoría financiera personalizada para organizar, proteger y hacer crecer tu dinero.</p>
        ...
        <section className="about section">
          <div className="container about-grid">
            ...
            <div className="about-text">
              ...
              <p>Obtuve un Bachillerato en Administración de Empresas en Mercadeo en la Universidad de Puerto Rico, donde también cursé estudios en finanzas, contabilidad y economía, adquiriendo una base fundamental para el análisis y gestión financiera.</p>
              ...
              <p>Estoy certificada como CPFC y CCFP (Certified Personal Financial Coach), lo que respalda mi preparación para orientar sobre organización financiera y toma de decisiones estratégicas.</p>
              <p>Además, soy Corredora de Bienes Raíces, lo que me permite integrar una visión más amplia sobre la creación de patrimonio y las oportunidades de inversión.</p>
