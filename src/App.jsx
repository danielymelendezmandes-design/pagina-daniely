    ...
    <div className="site">
      <header className="header">
        <div className="container header-inner">
          <div className="brand">
            <div className="brand-mark"><img src="/logo-daniely.jpg" alt="Logo Daniely Meléndez" className="brand-mark-logo" /></div>
            <div>
        ...
        <section className="about section">
          <div className="container about-grid">
            ...
            <div className="about-text">
              ...
              <p>Estoy certificada como CPFC & CCFP, credenciales profesionales que me permiten brindar consejería financiera y desarrollar estrategias.</p>
              <p>Además, soy Corredora de Bienes Raíces complementando mi enfoque con una visión más amplia sobre la creación de patrimonio y las oportunidades de inversión.</p>
